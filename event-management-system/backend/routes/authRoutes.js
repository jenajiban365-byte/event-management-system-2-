...
const { asyncRoute, publicUser } = require('../utils/routeHelpers');
...
}, 'Server error during registration.', { includeError: false, logLabel: 'REGISTRATION ERROR' }));
...
}, 'Server error during login.', { includeError: false }));
...
}, 'Server error verifying email.', { includeError: false }));
...
}, 'Server error resetting password.', { includeError: false }));
